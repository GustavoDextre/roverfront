        ...
        return (<div>
            <div className="fondoSolar">
                ...
                <section className="col-md-12 col-lg-6 text-center">
                    ...
                    <iframe id="cuadro" allowFullScreen="yes" scrolling="no" allowvr="yes" allow="gyroscope; xr-spatial-tracking;" src="https://aframeio.herokuapp.com/" title="Transmition..."></iframe>
